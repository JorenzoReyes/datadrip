...
All team members can be reached at their respective APC student email addresses.

## Project Details

- **Project Name**: DataDrip
- **Platform**: Next.js Web Application
- **Deployment**: Railway (Containerized with Docker)
- **Environment**: Production, Development, and Testing branches
